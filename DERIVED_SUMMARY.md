...
Quantum from compact time: `chsh_compact_time.py`, `chsh_closure.py`, `born1_envariance.py`, `born2_measure.py`, `born3_finegrain.py`, `born4_malus.py`, `born5_closure_knit.py`, `dis1_distinguish.py`, `dis2_ghz.py` (+ docs `CHSH0_prereg_compact.md`, `BORN0_prereg.md`, `DIS0_prereg.md`, `QUANTUM_FROM_COMPACT_TIME.md`); builds on `teotl qc.py`, `teotl chsh.py`.
